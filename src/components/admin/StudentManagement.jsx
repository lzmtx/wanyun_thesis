...
import { reqSelectAllStudent, reqAdminBatchAdditionStudentAccounts, reqUpdateUserSate } from '../../api'
...
export default class StudentManagement extends Component {
  ...
  getAllUserData = async (pageNum, pageSize) => {
    ...
    let res = await reqSelectAllStudent(...parameter)
      ...
      <div>
        ...
        >
          <Row>
            ...
            <Col span={20}>
              <ChildUploadFile
                url={reqAdminBatchAdditionStudentAccounts}
